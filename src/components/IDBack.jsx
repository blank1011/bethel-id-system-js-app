...
export default function IDBack({ student, validity, backTemplate, signatureImage, layout }) {
  ...
  if (backTemplate) {
    if (student.role === 'teacher') {
      return (
        <div className="id-back id-back--template-mode" id={`back-${student.lrn || student.studentNumber || student.employeeNumber}`}>
          <img
            src={backTemplate}
          ...
          <div className="id-back__ov id-back__ov--guardian" style={ov('guardianName')}>
            {student.guardianName || ''}
          </div>

          <div className="id-back__ov id-back__ov--guardian-address" style={ov('guardianAddress')}>
          ...
          <div className="id-back__ov id-back__ov--tin" style={ov('tin')}>{student.tin || ''}</div>
          <div className="id-back__ov id-back__ov--sss" style={ov('sss')}>{student.sss || ''}</div>
          <div className="id-back__ov id-back__ov--philhealth" style={ov('philhealth')}>{student.philhealth || ''}</div>
          <div className="id-back__ov id-back__ov--pagibig" style={ov('pagibig')}>{student.pagibig || ''}</div>
        </div>
      );
    }
    return (
  ...
  return (
    <div className="id-back" id={`back-${student.lrn || student.studentNumber || student.employeeNumber}`}>
      {student.role === 'teacher' ? (
        <>
          <div className="id-back__teacher-section">
            <div className="id-back__teacher-row">
              <div>
            ...
            <div className="id-back__teacher-fields">
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.guardianName || ''}</span>
                <span className="id-back__field-label">Guardian Name</span>
              </div>
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.guardianAddress || ''}</span>
                <span className="id-back__field-label">Guardian's Address</span>
              </div>
              <div className="id-back__field-group">
                {(student.contacts ? [student.contacts] : []).map((c, i) => (
              ...
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.tin || ''}</span>
                <span className="id-back__field-label">BIR TIN</span>
              </div>
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.sss || ''}</span>
                <span className="id-back__field-label">SSS Number</span>
              </div>
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.philhealth || ''}</span>
                <span className="id-back__field-label">PhilHealth Number</span>
              </div>
              <div className="id-back__field-group">
                <span className="id-back__field-value">{student.pagibig || ''}</span>
                <span className="id-back__field-label">Pag-Ibig Number</span>
              </div>
            </div>
          </div>
        </>
